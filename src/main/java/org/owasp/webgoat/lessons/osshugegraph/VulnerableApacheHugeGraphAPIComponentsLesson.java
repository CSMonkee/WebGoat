...
package org.owasp.webgoat.lessons.osshugegraph;
...
public class VulnerableApacheHugeGraphAPIComponentsLesson extends AssignmentEndpoint {

  Logger log = LoggerFactory.getLogger(this.getClass().getName());

  @PostMapping("/VulnerableApacheHugeGraphAPIComponents/CVE-2024-28109")
  public @ResponseBody AttackResult NacosYamlParser(
      @RequestParam String payload,
      @RequestParam(required = false, defaultValue = "true") Boolean isXsl) {
    //
    //		https://github.com/advisories/GHSA-qxqf-2mfx-x8jw  - CVE-2024-28109
    https: // security.snyk.io/vuln/SNYK-JAVA-ORGVERAPDF-6513793
    log.info("ConstructorWithload called with payload : {}", payload);
    //		SnakeYAMLDataFormat
    //		HugeSecurityManager
